        ...
        return (
            <div className="Post">
                ...
                <form className="searchTag">
                    <input placeholder="Найти заметку по тегу" value={this.props.tag} onChange={this.props.noteChange} />
                    <button className="tagButton" onClick={this.props.searchTag}>Найти</button>
                </form>
